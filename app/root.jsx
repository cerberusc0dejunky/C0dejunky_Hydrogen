...
import productModalStyles from '~/styles/product-modal.css?url';
import tabbedCollectionStyles from '~/styles/tabbed-collection.css?url';
import accountStyles from '~/styles/account.css?url';
import collectionsStyles from '~/styles/collections.css?url';
import repairStyles from '~/styles/repair.css?url';
  ...
  return (
    <html lang="en" data-theme="horizon">
      <head>
        ...
        <link rel="stylesheet" href={componentsStyles}></link>
        <link rel="stylesheet" href={productModalStyles}></link>
        <link rel="stylesheet" href={tabbedCollectionStyles}></link>
        <link rel="stylesheet" href={accountStyles}></link>
        <link rel="stylesheet" href={collectionsStyles}></link>
        <link rel="stylesheet" href={repairStyles}></link>
